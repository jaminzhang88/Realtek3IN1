 ...
 */
extern int  flag_join_success,flag_connect_fail,flag_region_get;
      ...
      //上电启动默认设置域名
       switch(flag_region_which){
              case 1:
                ...
                conf_cli(2, argv1);
                /*vTaskDelay(200);
                char *argv2[] = { "wifi", "join"};
                adw_wifi_cli(2, argv2);*/
                break;
              case 2:
                char *argv3[] = { "conf", "usr" };
                vTaskDelay(200);
                conf_cli(2, argv3);
                 /*vTaskDelay(200);
                char *argv4[] = { "wifi", "join"};
                adw_wifi_cli(2, argv4);*/
                break;
              case 3:
                char *argv5[] = { "conf", "eur" };
                vTaskDelay(200);
                conf_cli(2, argv5);
                /*vTaskDelay(200);
                char *argv6[] = { "wifi", "join"};
                adw_wifi_cli(2, argv6);*/
                break;
              default:
               /* char *argv3[] = { "conf", "cnr" };
                vTaskDelay(200);
